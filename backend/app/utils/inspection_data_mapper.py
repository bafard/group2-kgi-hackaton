...
# ADDED: Both underscore and space versions for Excel compatibility
INSPECTION_DATA_FIELD_MAPPING = {
    # Basic identification fields - space versions
    'ID': 'ID',
    ...
    # Basic identification fields - underscore versions  
    ...
    # Additional underscore versions for all common fields
    'Inspection_Date': 'Inspection_Date',
    'Customer_Name': 'Customer_Name',
    
    # Working conditions - space versions
    ...
    # Working conditions - underscore versions
    ...
    # Application codes - space versions
    ...
    # Application codes - underscore versions
    ...
    # Sprocket fields - underscore versions (for Excel files with underscore format)
...
# Legacy wrapper functions for backward compatibility with upload.py
def map_excel_to_database_columns(df_filtered):
    """
    Legacy wrapper for get_mapped_columns.
    ...
    Returns:
        dict: Column mapping {excel_col: db_col}
    """
    return get_mapped_columns(df_filtered.columns)


def filter_excel_columns_for_database(df):
    """
    Legacy wrapper that returns DataFrame as-is.
    The actual filtering is handled in upload.py after mapping.
    
    Args:
        df: pandas DataFrame
        
    Returns:
        pandas DataFrame: Same DataFrame (no filtering at this stage)
    """
    return df